...
async function loadMenu() {
  try {
        ...
        menuItems.forEach(item => {
            ...
            div.className = `col-lg-6 menu-item ${filterClass}`;
            div.innerHTML = `
                <img src="${item.imageUrl}" class="menu-img" alt="">
                <div class="menu-content">
                    <a href="#">${item.name}</a><span>₹${item.price.toLocaleString('en-IN')}</span>
                </div>
        ...
        // ⭐ IMPORTANT: Reinitialize isotope after DOM elements are added
        initIsotope();
...
function initIsotope() {
    ...
    setTimeout(() => {
        ...
        // Filter buttons
        let filters = document.querySelectorAll("#menu-flters li");
    ...
    }, 200); // Delay ensures items are fully painted
}
...
$(document).ready(function () {
  ...
  $("#header-placeholder").load("assets/page/header.html");
  $("#footer").load("assets/page/footer.html");
  $("#bookingList").load("assets/page/booking.html");
